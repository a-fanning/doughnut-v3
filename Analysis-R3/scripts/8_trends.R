...
#ggsave("./figures/8_socialIndicators-dataAndTrends_R3.png", width = 180, height = 184, units = "mm", device="png")
...
#ggsave("./figures/8_ecologicalIndicators-dataAndTrends_R3.png", width = 180, height = 140, units = "mm", device="png")
