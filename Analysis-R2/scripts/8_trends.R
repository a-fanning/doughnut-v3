...
#ggsave("./figures/8_socialIndicators-dataAndTrends_R2.png", width = 180, height = 184, units = "mm", device="png")
...
#ggsave("./figures/8_ecologicalIndicators-dataAndTrends-greys_R2.png", width = 180, height = 140, units = "mm", device="png")
...
#write_csv(obsFit, "./myData/8_20250113_ratios-observedAndFitted.csv")
...
#write_csv(myReg2, "./myData/8_20250113_lmModelCoefficients.csv")
